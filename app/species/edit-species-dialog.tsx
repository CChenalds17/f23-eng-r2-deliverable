  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogTrigger asChild>
        ...
        >
          <Icons.post className="mr-3 h-5 w-5" />
          Edit
        </Button>
      </DialogTrigger>
      <DialogContent className="max-h-screen overflow-y-auto sm:max-w-[600px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Edit your existing species here. Click &quot;Done&quot; below when you&apos;re done.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input defaultValue={species.scientific_name} onChange={(event) => field.onChange(event.target.value)} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                render={({ field }) => {
                  ...
                  return (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input defaultValue={species.common_name ?? ""} onChange={(event) => field.onChange(event.target.value)} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  );
